...
/datum/sex_action/stockjob/on_start(mob/living/carbon/human/user, mob/living/carbon/human/target)
		user.visible_message(span_warning"[user] begins grinding the stock of [user.p_their()] weapon into [target]'s groin..."")

/datum/sex_action/stockjob/on_perform(mob/living/carbon/human/user, mob/living/carbon/human/target)
	user.visible_message(user.sexcon.spanify_force("[user] [user.sexcon.get_generic_force_adjective()] grinds their weapon against [target]."))
...
/datum/sex_action/stockjob/on_finish(mob/living/carbon/human/user, mob/living/carbon/human/target)
	user.visible_message(span_warning("[user] stops grinding their weapon against [target]."))
